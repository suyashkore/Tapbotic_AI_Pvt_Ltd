...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | Enterprise Software</title>
  <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
  ...
  <body class=" dark-theme "> 
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      <div class="overlay-photo-image-bg parallax" data-bg-img="https://images.pexels.com/photos/3183197/pexels-photo-3183197.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" data-bg-opacity="1"></div>
      <div class="overlay-color" data-bg-opacity=".75"></div>
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Enterprise Software</h1>
          <nav aria-label="breadcrumb ">
            <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
              ...
              <li class="breadcrumb-item active">Enterprise Software</li>
            </ul>
          </nav>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/otherimages/11.jpeg" alt="A team of software engineers collaborating on a project" style="max-height: 450px; width: 100%; object-fit: cover;"></div>
              <div class="service-content">
                <div class="part">
                  <h2 class="service-title">Large-Scale Software Engineering</h2>
                  <p class="service-text">Tapbotic AI engineers robust, scalable, and secure enterprise software solutions that form the digital backbone of your organization. We follow a disciplined, architecture-first approach to build mission-critical systems that are designed for performance, longevity, and compliance.</p>
                  <p class="service-text">Our team has deep expertise in developing complex applications, from custom ERPs and CRMs to industry-specific platforms. We manage the entire software development lifecycle, from initial concept and design to deployment, and ongoing maintenance.</p>
                </div>
                <div class="part">
                  <h2 class="service-title">Our Software Engineering Services</h2>
                  <div class="info-items-list">
                    <div class="row">
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            <h5 class="info-title">Web Application Development</h5>
                            <p class="info-text">Building powerful, responsive, and secure web applications to meet your business requirements.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">02.</span>
                          <div class="info-content">
                            <h5 class="info-title">Enterprise Software Solutions</h5>
                            <p class="info-text">Developing custom enterprise-grade software for functions like ERP, SCM, and CRM.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">03.</span>
                          <div class="info-content">
                            <h5 class="info-title">SaaS Product Development</h5>
                            <p class="info-text">End-to-end development of multi-tenant, cloud-native SaaS products from idea to market.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">04.</span>
                          <div class="info-content">
                            <h5 class="info-title">API & System Integration</h5>
                            <p class="info-text">Seamlessly connecting your disparate systems and applications through robust API development and integration.</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  ...
                  <li class="list-item active"><i class="flaticon-web-development font-icon"></i><a href="service-software.php"> Enterprise Software<i class="bi bi-arrow-right icon "></i></a></li>
