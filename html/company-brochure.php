...
<html lang="zxx">
  <head>
    ...
    <meta name="description" content="Download the official company brochure for Tapbotic AI Pvt Ltd.">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | Company Brochure</title>
  </head>
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Company Brochure</h1>
            ...
            <div class="service-content-area">
              <div class="service-content">
                <div class="part text-center">
                  <h2 class="service-title">Download Our Company Brochure</h2>
                  <p class="service-text">Get a comprehensive overview of Tapbotic AI Pvt Ltd, our vision, services, and the value we bring to our enterprise partners. Our brochure details our core capabilities in Artificial Intelligence, Automation, and large-scale software engineering.</p>
                  <div class="cta-area mt-4">
                    <a class="btn-solid" href="assets/docs/tapbotic-company-brochure.pdf" download>Download Brochure <i class="bi bi-download icon"></i></a>
                  </div>
                </div>
              </div>
            </div>
