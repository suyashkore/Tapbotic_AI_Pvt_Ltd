...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | Automation Solutions</title>
  <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
  ...
  <body class=" dark-theme "> 
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      <div class="overlay-photo-image-bg parallax" data-bg-img="https://images.pexels.com/photos/7108033/pexels-photo-7108033.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" data-bg-opacity="1"></div>
      <div class="overlay-color" data-bg-opacity=".75"></div>
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Automation Solutions</h1>
          <nav aria-label="breadcrumb ">
            <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
              ...
              <li class="breadcrumb-item active">Automation Solutions</li>
            </ul>
          </nav>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/otherimages/3.png" alt="A robotic arm working on a production line, symbolizing industrial automation" style="max-height: 450px; width: 100%; object-fit: cover;"></div>
              <div class="service-content">
                <div class="part">
                  <h2 class="service-title">Intelligent Automation & Robotics Software</h2>
                  <p class="service-text">Tapbotic AI specializes in transforming business operations through intelligent automation. We design and deploy sophisticated automation solutions that streamline workflows, reduce manual effort, and enhance productivity. Our services cover the full spectrum of automation, from task-based robotics to complex, AI-driven process orchestration.</p>
                  <p class="service-text">We help organizations identify automation opportunities, build scalable 'bots', and manage their digital workforce. Our goal is to free up your human talent to focus on high-value, strategic initiatives while our automation solutions handle the repetitive, rule-based tasks with speed and accuracy.</p>
                </div>
                <div class="part">
                  <h2 class="service-title">Our Core Automation Offerings</h2>
                  <div class="info-items-list">
                    <div class="row">
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            <h5 class="info-title">Robotic Process Automation (RPA)</h5>
                            <p class="info-text">Deploying software robots to automate high-volume, repetitive tasks across applications and systems.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">02.</span>
                          <div class="info-content">
                            <h5 class="info-title">Intelligent Process Automation (IPA)</h5>
                            <p class="info-text">Combining RPA with AI technologies like NLP and computer vision to automate more complex, cognitive processes.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">03.</span>
                          <div class="info-content">
                            <h5 class="info-title">Business Workflow Automation</h5>
                            <p class="info-text">Designing and implementing end-to-end automated workflows to connect disparate systems and departments.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">04.</span>
                          <div class="info-content">
                            <h5 class="info-title">Automation Center of Excellence (CoE)</h5>
                            <p class="info-text">Helping you establish governance, best practices, and a scalable framework for enterprise-wide automation.</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="service-sidebar ">
              ...
              <div class="sidebar-pane">
                <div class="download-area">
                  ...
                  <p class="sidebar-text">Learn more about our automation services and successful use cases.</p>
                  <ul class="list">
