...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | Cybersecurity</title>
  <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
  ...
  <body class=" dark-theme "> 
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      <div class="overlay-photo-image-bg parallax" data-bg-img="https://images.pexels.com/photos/60504/security-protection-anti-virus-software-60504.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" data-bg-opacity="1"></div>
      <div class="overlay-color" data-bg-opacity=".75"></div>
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Cybersecurity</h1>
          <nav aria-label="breadcrumb ">
            <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
              ...
              <li class="breadcrumb-item active">Cybersecurity</li>
            </ul>
          </nav>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/otherimages/5.jpeg" alt="A person working on a laptop with cybersecurity code overlay" style="max-height: 450px; width: 100%; object-fit: cover;"></div>
              <div class="service-content">
                <div class="part">
                  <h2 class="service-title">Cybersecurity, Risk Management & Compliance</h2>
                  <p class="service-text">In today's digital landscape, protecting your assets is paramount. Tapbotic AI offers comprehensive cybersecurity services to safeguard your organization against evolving threats. We take a proactive, multi-layered approach to security, ensuring the confidentiality, integrity, and availability of your critical data and systems.</p>
                  <p class="service-text">Our team of security experts helps you identify vulnerabilities, manage risks, and achieve regulatory compliance. We implement robust security controls and provide continuous monitoring to defend your enterprise from the inside out.</p>
                </div>
                <div class="part">
                  <h2 class="service-title">Our Cybersecurity Services</h2>
                  <div class="info-items-list">
                    <div class="row">
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            <h5 class="info-title">Application & Network Security</h5>
                            <p class="info-text">Securing your applications and network infrastructure against unauthorized access and attacks.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">02.</span>
                          <div class="info-content">
                            <h5 class="info-title">Vulnerability Assessment & Penetration Testing</h5>
                            <p class="info-text">Identifying and exploiting security weaknesses to understand and mitigate your risk exposure.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">03.</span>
                          <div class="info-content">
                            <h5 class="info-title">Secure Architecture Design</h5>
                            <p class="info-text">Building security into your systems from the ground up with a 'secure-by-design' philosophy.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">04.</span>
                          <div class="info-content">
                            <h5 class="info-title">Compliance & Risk Management</h5>
                            <p class="info-text">Helping you navigate complex regulatory landscapes and maintain compliance with industry standards.</p>
                          </div>
                        </div>
                      </div>
                    </div>
