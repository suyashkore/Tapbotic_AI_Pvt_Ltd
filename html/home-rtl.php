...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title> Tapbotic AI Pvt Ltd   |   Home-RTL</title>
  <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
  ...
  <body class=" dark-theme ">
    ...
    <section class="page-hero  d-flex align-items-center  " id="page-hero">
      ...
      <div class="container">
        <div class="row align-items-center gy-5 g-lg-0">
          ...
          <!--start of .image-area -->
          <div class="col-10   mx-auto col-lg-6 text-center " data-tilt>  
        ...
        <div class="row gx-4 gy-4 services-row ">  
          <div class="col-12 col-md-6  col-lg-4 mx-auto ">
            ...
            <div class="box service-box  wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".1s">
              ...
              </div><a class="read-more" href="service-single.php">المزيد<i class="bi bi-arrow-left icon "></i></a>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-12 col-lg-6 d-flex align-items-center about-col pad-start  wow fadeInUp " data-wow-delay="0.6s">
              <div class="text-area ">
                ...
                <div class="cta-area "><a class=" btn-solid " href="about-us.php">get in toutch</a></div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="portfolio mega-section   " id="portfolio">
      <div class="container">
        <div class="sec-heading  ">
          ...
          <div class=" cta-area   wow fadeInUp" data-wow-delay=".8s"><a class="cta-btn btn-solid    " href="portfolio-grid.php">see more <i class="bi bi-arrow-left icon "></i></a></div>
        </div>
    ...
    <section class="pricing mega-section  " id="pricing-1">
      <div class="container">
        <div class="sec-heading  ">
          ...
          <div class=" cta-area   wow fadeInUp" data-wow-delay=".8s"><a class="cta-btn btn-solid    " href="pricing.php">see all plans<i class="bi bi-arrow-left icon "></i></a></div>
        </div>
        <div class="row">
          <!--First Plan-->
    ...
    <section class="blog blog-home mega-section  " id="blog">
      <div class="container ">
        <div class="sec-heading  ">
          ...
          <div class=" cta-area  cta-area  wow fadeInUp" data-wow-delay=".8s"><a class="cta-btn btn-solid   cta-btn btn-solid  " href="blog-home-3-col.php">see all posts<i class="bi bi-arrow-left icon "></i></a></div>
        </div>
        <div class="row ">
          <div class="col-12 "> 
            <div class="posts-grid ">
              <div class="row">
                <div class="col-12 col-lg-4 ">
                  <div class="post-box">     <a class="post-link" href="post-single.php" title="هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة"> 
                    ...
                    <div class="post-summary">
                      ...
                      <div class="post-text"><a class="post-link" href="post-single.php"> 
                        ...
                        <p class="post-excerpt">ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملاً،دور مولد النص العربى أن يوفر</p><a class="read-more" href="post-single.php" title="هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة">المزيد<i class="bi bi-arrow-left icon "></i></a>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-lg-4 ">         
                  <div class="post-box">     <a class="post-link" href="post-single.php" title="هذا و قد تم توليد هذا النص المؤقت من مولد النص العربى"> 
                    ...
                    <div class="post-summary">
                      ...
                      <div class="post-text"><a class="post-link" href="post-single.php"> 
                        ...
                        <p class="post-excerpt">ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملاً،دور مولد النص العربى أن يوفر</p><a class="read-more" href="post-single.php" title="هذا و قد تم توليد هذا النص المؤقت من مولد النص العربى">المزيد<i class="bi bi-arrow-left icon "></i></a>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-lg-4 ">         
                  <div class="post-box">     <a class="post-link" href="post-single.php" title="حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص"> 
                    ...
                    <div class="post-summary">
                      ...
                      <div class="post-text"><a class="post-link" href="post-single.php"> 
                        ...
                        <p class="post-excerpt">ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملاً،دور مولد النص العربى أن يوفر</p><a class="read-more" href="post-single.php" title="حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص">المزيد<i class="bi bi-arrow-left icon "></i></a>
                      </div>
                    </div>
                  </div>
                </div>
