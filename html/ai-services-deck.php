...
<html lang="zxx">
  <head>
    ...
    <meta name="description" content="Download the AI Services Deck for Tapbotic AI Pvt Ltd.">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | AI Services Deck</title>
  </head>
  <body class=" dark-theme "> 
    ...
    <header class=" page-header   inner-page-header header-basic" id="page-header">
      ...
      <nav class="menu-navbar">
        <div class="header-logo"><a class="logo-link" href="index.php"><img class="logo-img light-logo" loading="lazy"
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">AI Services Deck</h1>
          <nav aria-label="breadcrumb ">
            <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
              ...
              <li class="breadcrumb-item active">AI Services Deck</li>
            </ul>
          </nav>
        </div>
      </div>
            ...
            <div class="service-content-area">
              <div class="service-content">
                <div class="part text-center">
                  <h2 class="service-title">Download Our AI Services Deck</h2>
                  <p class="service-text">Explore our AI services in detail. This presentation provides an in-depth look at our capabilities in Machine Learning, Predictive Analytics, NLP, Computer Vision, and how we apply them to solve real-world business problems.</p>
                  <div class="cta-area mt-4">
                    <a class="btn-solid" href="assets/docs/tapbotic-ai-services-deck.pdf" download>Download AI Deck <i class="bi bi-download icon"></i></a>
                  </div>
                </div>
              </div>
            </div>
