  ...
  <html lang="zxx">
    ...
    <body class=" dark-theme ">
        ...
        <nav class="menu-navbar">
          ...
          <div class="links menu-wrapper ">
            <ul class="list-js links-list">
              ...
              <!-- <li class="menu-item"><a class="menu-link" href="#0">Governance</a></li> -->
              ...
              <div class="col-12 col-lg-6 d-flex align-items-center order-1 order-lg-0 about-col pad-end  wow fadeInUp " data-wow-delay="0.6s">
                <div class="text-area ">
                  <div class="sec-heading  light-title ">
                    <div class="content-area"><span class=" pre-title       wow fadeInUp " data-wow-delay=".2s">Company Overview</span>
                      <h2 class=" title    wow fadeInUp" data-wow-delay=".4s">A Technology-Driven Organization</h2>
                    </div>
                  </div>
                  <p class=" about-text">Tapbotic AI Pvt Ltd is a technology-driven organization specializing in Artificial Intelligence, Automation, and Digital Transformation. Since our founding in 2017, we have been committed to delivering innovative, reliable, and scalable technology solutions.</p>
      ...
      <!-- End  about Section-->
      <!-- Start  our-purpose Section-->
      <section class="our-purpose mega-section" id="our-purpose">
        <div class="container">
          <div class="row">
              ...
              <div class="purpose-card wow fadeInUp" data-wow-delay=".4s">
                ...
                <div class="purpose-content">
                  ...
                  <ul class="list-unstyled">
                    <li> <i class="bi bi-check2-circle icon"></i>Deliver intelligent and scalable technology solutions</li>
                    <li> <i class="bi bi-check2-circle icon"></i>Enable digital transformation using AI and automation</li>
      ...
      <!-- End  our-purpose Section-->
      <!-- Start  why-us Section-->
      <section class="why-us mega-section" id="why-us">
        <div class="container">
          <div class="sec-heading  centered ">
            <div class="content-area"><span class=" pre-title       wow fadeInUp " data-wow-delay=".2s">Core Values</span>
              <h2 class=" title    wow fadeInUp" data-wow-delay=".4s">Our <span class='hollow-text'>Guiding</span> Principles</h2>
            </div>
          </div>
          <div class="row">
            <div class="col-12 col-md-6 col-lg-4">
              <div class="info-item  wow fadeInUp" data-wow-delay="0.2s"><i class="flaticon-idea info-icon"></i>
                <div class="info-content">
                  <h5 class="info-title">Innovation & Excellence</h5>
                  <p class="info-text">We strive for excellence through continuous innovation and improvement.</p>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
              <div class="info-item  wow fadeInUp" data-wow-delay="0.3s"><i class="flaticon-handshake info-icon"></i>
                <div class="info-content">
                  <h5 class="info-title">Integrity & Transparency</h5>
                  <p class="info-text">We uphold the highest standards of integrity and transparency in all our actions.</p>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
              <div class="info-item  wow fadeInUp" data-wow-delay="0.4s"><i class="flaticon-user info-icon"></i>
                <div class="info-content">
                  <h5 class="info-title">Customer-Centricity</h5>
                  <p class="info-text">Our clients are at the center of everything we do.</p>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
              <div class="info-item  wow fadeInUp" data-wow-delay="0.5s"><i class="flaticon-security info-icon"></i>
                <div class="info-content">
                  <h5 class="info-title">Security & Reliability</h5>
                  <p class="info-text">We are committed to providing secure and reliable solutions.</p>
                </div>
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
              <div class="info-item  wow fadeInUp" data-wow-delay="0.6s"><i class="flaticon-book-1 info-icon"></i>
                <div class="info-content">
                  <h5 class="info-title">Continuous Learning</h5>
                  <p class="info-text">We foster a culture of continuous learning and development.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
                <div class="tm-member-card     wow   fadeInUp" data-wow-delay="0.1s">
                  <div class="tm-image js-tilt "><a class="tm-link  " href="team-member.php"> 
                      <div class="overlay overlay-color"></div><img class="img-fluid parallax-img  " loading="lazy" src="assets/images/our-team/9.jpeg" alt="Team Member"/></a>
                    <div class="tm-social">
                  ...
                  <div class="tm-details"><a class="tm-link" href="team-member.php"> 
                      <h6 class="tm-name"></h6></a><span class="tm-role">co Founder</span></div>
                </div>
              </div>
              <!--Second Team Member-->
              <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
                <div class="tm-member-card     wow   fadeInUp" data-wow-delay="0.2s">
                  <div class="tm-image js-tilt "><a class="tm-link  " href="team-member.php"> 
                      <div class="overlay overlay-color"></div><img class="img-fluid parallax-img  " loading="lazy" src="assets/images/our-team/11.jpeg" alt="Team Member"/></a>
                    <div class="tm-social">
                      <div class="sc-wrapper dir-row sc-size-40">
                         <!-- <ul class="sc-list">
                          <li class="sc-item " title="Facebook"><a class="sc-link" href="https://www.facebook.com/profile.php?id=61576857460606" title="social media icon"><i class="fab fa-facebook-f sc-icon"></i></a></li>
                  ...
                  <div class="tm-details"><a class="tm-link" href="team-member.php"> 
                      <h6 class="tm-name"></h6></a><span class="tm-role">manager   </span></div>
                </div>
              </div>
              <!--Third Team Member-->
              <div class="col-12 col-md-8  col-lg-4 mx-md-auto ">
                <div class="tm-member-card     wow   fadeInUp" data-wow-delay="0.4s">
                  <div class="tm-image js-tilt "><a class="tm-link  " href="team-member.php"> 
                      <div class="overlay overlay-color"></div><img class="img-fluid parallax-img  " loading="lazy" src="assets/images/our-team/13.jpeg" alt="Team Member"/></a>
                    <div class="tm-social">
                      <div class="sc-wrapper dir-row sc-size-40">
                          <!-- <ul class="sc-list">
                          <li class="sc-item " title="Facebook"><a class="sc-link" href="https://www.facebook.com/profile.php?id=61576857460606" title="social media icon"><i class="fab fa-facebook-f sc-icon"></i></a></li>
                  ...
                  <div class="tm-details"><a class="tm-link" href="team-member.php"> 
                      <h6 class="tm-name"></h6></a><span class="tm-role">co leader</span></div>
                </div>
              </div>
            </div>
          </div>
