...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | Terms & Conditions</title>
  <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
  ...
  <body class=" dark-theme "> 
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      <div class="overlay-photo-image-bg parallax" data-bg-img="https://images.pexels.com/photos/5668858/pexels-photo-5668858.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" data-bg-opacity="1"></div>
      <div class="overlay-color" data-bg-opacity=".75"></div>
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Terms & Conditions</h1>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/otherimages/12.jpeg" alt="Signing Terms & Conditions document" style="max-height: 450px; width: 100%; object-fit: cover;"></div>
              <div class="service-content">
                <div class="part">
                  <h2 class="service-title">Introduction</h2>
                  <p class="service-text">Welcome to Tapbotic AI Pvt Ltd. These terms and conditions outline the rules and regulations for the use of our website and services.</p>
                </div>
                <div class="part">
                  <h2 class="service-title">Use of Our Services</h2>
                  <p class="service-text">By accessing this website, we assume you accept these terms and conditions. Do not continue to use Tapbotic AI's website if you do not agree to all of the terms and conditions stated on this page.</p>
                </div>
                <div class="part">
                  <h2 class="service-title">Intellectual Property</h2>
                  <p class="service-text">The content, layout, design, data, databases and graphics on this website are protected by intellectual property laws and are owned by Tapbotic AI Pvt Ltd unless otherwise stated.</p>
                </div>
                <div class="part">
                  <h2 class="service-title">Limitation of Liability</h2>
                  <p class="service-text">In no event shall Tapbotic AI, nor any of its officers, directors and employees, be held liable for anything arising out of or in any way connected with your use of this website.</p>
                </div>
                <div class="part">
                  <h2 class="service-title">Governing Law</h2>
                  <p class="service-text">These terms will be governed by and interpreted in accordance with the laws of India, and you submit to the non-exclusive jurisdiction of the state and federal courts located in Pune for the resolution of any disputes.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  ...
                  <li class="list-item active"><i class="flaticon-file font-icon"></i><a href="terms-conditions.php"> Terms & Conditions<i class="bi bi-arrow-right icon "></i></a></li>
                </ul>
              </div>
              <div class="sidebar-pane">
