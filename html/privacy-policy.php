...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | Privacy Policy</title>
  <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
  ...
  <body class=" dark-theme "> 
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      <div class="overlay-photo-image-bg parallax" data-bg-img="https://images.pexels.com/photos/5380642/pexels-photo-5380642.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" data-bg-opacity="1"></div>
      <div class="overlay-color" data-bg-opacity=".75"></div>
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Privacy Policy</h1>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/otherimages/1.jpeg" alt="Privacy Policy" style="max-height: 450px; width: 100%; object-fit: cover;"></div>
              <div class="service-content">
                <div class="part">
                  <h2 class="service-title">Our Commitment to Your Privacy</h2>
                  <p class="service-text">Tapbotic AI Pvt Ltd ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.</p>
                </div>
                <div class="part">
                  <div class="faq-accordion" id="privacy-policy-accordion">
                    <div class="card mb-2">
                      <div class="card-header" id="heading-policy-1">
                        <h5 class="mb-0 faq-title">
                          <button class="btn btn-link faq-btn" data-bs-toggle="collapse" data-bs-target="#collapse-policy-1" aria-expanded="true" aria-controls="collapse-policy-1">
                            Information We Collect
                          </button>
                        </h5>
                      </div>
                      <div id="collapse-policy-1" class="collapse show" aria-labelledby="heading-policy-1" data-bs-parent="#privacy-policy-accordion">
                        <div class="card-body">
                          <p class="faq-answer">We may collect personal information that you voluntarily provide to us when you fill out a contact form, apply for a career, or otherwise interact with our services. This may include your name, email address, phone number, and any other information you choose to provide.</p>
                        </div>
                      </div>
                    </div>
                    <div class="card mb-2">
                      <div class="card-header" id="heading-policy-2">
                        <h5 class="mb-0 faq-title">
                          <button class="btn btn-link faq-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-policy-2" aria-expanded="false" aria-controls="collapse-policy-2">
                            How We Use Your Information
                          </button>
                        </h5>
                      </div>
                      <div id="collapse-policy-2" class="collapse" aria-labelledby="heading-policy-2" data-bs-parent="#privacy-policy-accordion">
                        <div class="card-body">
                          <p class="faq-answer">We use the information we collect to: respond to your inquiries, process your applications, provide and improve our services, and communicate with you about our offerings.</p>
                        </div>
                      </div>
                    </div>
                    <div class="card mb-2">
                      <div class="card-header" id="heading-policy-3">
                        <h5 class="mb-0 faq-title">
                          <button class="btn btn-link faq-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-policy-3" aria-expanded="false" aria-controls="collapse-policy-3">
                            Data Security
                          </button>
                        </h5>
                      </div>
                      <div id="collapse-policy-3" class="collapse" aria-labelledby="heading-policy-3" data-bs-parent="#privacy-policy-accordion">
                        <div class="card-body">
                          <p class="faq-answer">We implement a variety of security measures to maintain the safety of your personal information. However, no method of transmission over the Internet or method of electronic storage is 100% secure.</p>
                        </div>
                      </div>
                    </div>
                    <div class="card mb-2">
                      <div class="card-header" id="heading-policy-4">
                        <h5 class="mb-0 faq-title">
                          <button class="btn btn-link faq-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-policy-4" aria-expanded="false" aria-controls="collapse-policy-4">
                            Your Rights
                          </button>
                        </h5>
                      </div>
                      <div id="collapse-policy-4" class="collapse" aria-labelledby="heading-policy-4" data-bs-parent="#privacy-policy-accordion">
                        <div class="card-body">
                          <p class="faq-answer">You have the right to access, correct, or delete your personal information. If you wish to exercise these rights, please contact us.</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="col-12 col-xl-4">
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  <li class="list-item active"><i class="flaticon-security font-icon"></i><a href="privacy-policy.php"> Privacy Policy<i class="bi bi-arrow-right icon "></i></a></li>
