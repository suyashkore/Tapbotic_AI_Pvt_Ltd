...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title> Tapbotic AI Pvt Ltd   |   Home-1</title>
  <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
    ...
    <section class="portfolio mega-section   " id="portfolio">
      <div class="container">
        <div class="sec-heading  ">
          ...
          <div class=" cta-area   wow fadeInUp" data-wow-delay=".8s"><a class="cta-btn btn-solid    " href="portfolio-grid.php">see more <i class="bi bi-arrow-right icon "></i></a></div>
        </div>
