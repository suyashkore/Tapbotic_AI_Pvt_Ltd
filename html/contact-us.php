...
<head>
  ...
  <meta name="description" content="Contact Tapbotic AI Pvt Ltd - Get in touch with our team">
  ...
  <section class="contact-us mega-section pb-0" id="contact-us">
    <div class="container">
      ...
      <section class="locations-section mega-section">
        <div class="sec-heading centered">
          <div class="content-area">
            <h2 class="title wow fadeInUp" data-wow-delay=".4s">Our Offices</h2>
          </div>
        </div>
                ...
                <div class="info-panel wow fadeInUp" data-wow-delay=".4s">
                  ...
                  <div class="location-card"><i class="flaticon-email icon"></i>
                    <div class="card-content">
                      ...
                      <a class="email link" href="mailto:tapboticai.com">tapboticai.com</a>
                    </div>
                  </div>
                  <div class="location-card"><i class="flaticon-phone-call icon"></i>
                    <div class="card-content">
                      <h6 class="content-title">Phone:</h6>
                      <a class="tel link" href="tel:+91XXXXXXXXXX">+91-XXXXXXXXXX</a>
                    </div>
                  </div>
                </div>
              </div> -->
              ...
              <div class="col-12 col-lg-6">
                <div class="info-panel wow fadeInUp" data-wow-delay=".6s">
                  ...
                  <div class="location-card"><i class="flaticon-phone-call icon"></i>
                    <div class="card-content">
                      <h6 class="content-title">Phone:</h6>
                      <a class="tel link" href="tel:++91 7066067737">+91-7066067737</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="custom-form-area input-boxed">
                  ...
                  <form class="main-form" id="contact-us-form" action="php/send-mail.php" method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-lg-6">
                        <div class="input-wrapper">
                          <input class="text-input" id="user-phone" name="UserPhone" type="text" />
                          <label class="input-label" for="user-phone"> Phone <span class="req">*</span></label>
                          <span class="b-border"></span>
                          <span class="error-msg"></span>
                        </div>
                      </div>
                      <div class="col-12 col-lg-6">
                        <div class="input-wrapper">
                          <input class="text-input" id="user-company" name="UserCompany" type="text" />
                          <label class="input-label" for="user-company"> Company Name</label>
                          <span class="b-border"></span>
                          <span class="error-msg"></span>
                        </div>
                      </div>
