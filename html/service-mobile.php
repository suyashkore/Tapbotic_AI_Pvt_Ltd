...
<html lang="zxx">
  <head>
    ...
    <meta name="description" content="Secure and scalable mobile app development services by Tapbotic AI.">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | Secure Digital & Mobile Platforms</title>
  <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
  ...
  <body class=" dark-theme "> 
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      <div class="overlay-photo-image-bg parallax" data-bg-img="https://images.pexels.com/photos/1786433/pexels-photo-1786433.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" data-bg-opacity="1"></div>
      <div class="overlay-color" data-bg-opacity=".75"></div>
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Secure Digital & Mobile Platforms</h1>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/otherimages/7.jpeg" alt="A person using a mobile phone with app icons floating around" style="max-height: 450px; width: 100%; object-fit: cover;"></div>
              <div class="service-content">
                <div class="part">
                  <h2 class="service-title">Secure Digital & Mobile Platforms</h2>
                  <p class="service-text">Tapbotic AI builds user-focused mobile applications and secure digital platforms for modern businesses. We combine intuitive UI/UX design with robust, scalable backend architecture to deliver high-performance mobile experiences that engage users and drive business objectives.</p>
                  <p class="service-text">Our expertise spans native iOS and Android development, as well as cross-platform solutions that maximize reach and minimize development costs. We integrate AI and machine learning capabilities to create smart, personalized mobile apps that stand out in a crowded marketplace.</p>
                </div>
                <div class="part">
                  <h2 class="service-title">Our Mobile Development Services</h2>
                  <div class="info-items-list">
                    <div class="row">
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            <h5 class="info-title">Android & iOS App Development</h5>
                            <p class="info-text">Building high-performance, native applications for the world's leading mobile operating systems.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">02.</span>
                          <div class="info-content">
                            <h5 class="info-title">Cross-Platform Applications</h5>
                            <p class="info-text">Developing efficient, single-codebase apps that run seamlessly on both iOS and Android.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">03.</span>
                          <div class="info-content">
                            <h5 class="info-title">AI-Powered Mobile Apps</h5>
                            <p class="info-text">Integrating machine learning models to create intelligent features like personalization and predictive analytics.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">04.</span>
                          <div class="info-content">
                            <h5 class="info-title">UI/UX Design & Optimization</h5>
                            <p class="info-text">Crafting beautiful, intuitive user interfaces that provide an exceptional user experience and drive engagement.</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  ...
                  <li class="list-item"><i class="flaticon-automation font-icon"></i><a href="service-automation.php"> Automation Solutions<i class="bi bi-arrow-right icon "></i></a></li>
                  ...
                  <li class="list-item active"><i class="flaticon-profile font-icon"></i><a href="service-mobile.php"> Mobile Platforms<i class="bi bi-arrow-right icon "></i></a></li>
              ...
              <div class="sidebar-pane">
                <div class="download-area">
                  ...
                  <p class="sidebar-text">Learn more about our mobile platform capabilities.</p>
                  <ul class="list">
                    ...
                    <li class="list-item"><i class="flaticon-downloading font-icon"></i><a href="#0">
                         Mobile Platforms Deck<i class="bi bi-arrow-right icon "></i></a></li>
                  </ul>
                </div>
              </div>
              <div class="sidebar-pane">
