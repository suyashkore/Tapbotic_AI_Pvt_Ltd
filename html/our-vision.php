...
<head>
    ...
    <meta name="description" content="Our Vision - Tapbotic AI Pvt Ltd">
    ...
    <title> Our Vision | Tapbotic AI Pvt Ltd</title>
    <style>
    /* .mouse-bubble {
      position: absolute;
      border-radius: 50%;
...
<body class=" dark-theme ">
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
        ...
        <div class="container">
          <div class="hero-text-area centerd">
            <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Our Vision</h1>
    ...
    <section class="about mega-section" id="vision-details">
        <div class="container">
            ...
            <div class="row">
              <div class="col-12 col-lg-6 d-flex align-items-center order-1 order-lg-0 about-col pad-end wow fadeInUp" data-wow-delay="0.6s">
                <div class="text-area">
                  <div class="sec-heading light-title">
                    <div class="content-area"><span class="pre-title wow fadeInUp" data-wow-delay=".2s">Future Forward</span>
                      <h2 class="title wow fadeInUp" data-wow-delay=".4s">Driving Global Innovation</h2>
                    </div>
                  </div>
                  <p class="about-text">To become a globally recognized leader in Artificial Intelligence and Automation, driving innovation and sustainable growth for businesses worldwide.</p>
                  <p class="about-text">We envision a future where technology seamlessly integrates with human potential to solve complex challenges. Our vision extends beyond just providing services; we aim to be the catalyst for digital evolution, empowering enterprises to achieve unprecedented efficiency and intelligence in their operations.</p>
                </div>
              </div>
              <div class="col-12 col-lg-6 d-flex align-items-center order-0 order-lg-1 about-col wow fadeInUp" data-wow-delay="0.2s">
                <div class="img-area" data-tilt>
                  <div class="image"><img class="about-img img-fluid" loading="lazy" src="assets/images/our-purpose/vision_new.png" alt="Our Vision"></div>
                </div>
              </div>
            </div>
          </div>
