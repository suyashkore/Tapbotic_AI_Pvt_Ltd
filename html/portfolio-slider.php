...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title> Tapbotic AI Pvt Ltd   |   Portfolio</title>
  <!--  <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
  ...
  <body class=" dark-theme "> 
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      <div class="overlay-photo-image-bg parallax" data-bg-img="https://images.pexels.com/photos/326503/pexels-photo-326503.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" data-bg-opacity="1"></div>
      ...
      <div class="container">
        ...
        <div class="swiper-container wow fadeIn" data-wow-delay=".5s">
          <div class="swiper-wrapper ">
            ...
            <div class="swiper-slide">
              <div class="item   "><a class="portfolio-img-link" href="service-automation.php"><img class="portfolio-img   img-fluid " loading="lazy" src="assets/images/portfolio/2.jpg" alt="portfolio item photo"/></a>
                <div class="item-info ">
            ...
            <div class="swiper-slide">
              <div class="item   "><a class="portfolio-img-link" href="service-software.php"><img class="portfolio-img   img-fluid " loading="lazy" src="assets/images/portfolio/3.jpg" alt="portfolio item photo"/></a>
                <div class="item-info ">
            ...
            <div class="swiper-slide">
              <div class="item   "><a class="portfolio-img-link" href="service-automation.php"><img class="portfolio-img   img-fluid " loading="lazy" src="assets/images/portfolio/4.jpg" alt="portfolio item photo"/></a>
                <div class="item-info ">
            ...
            <div class="swiper-slide">
              <div class="item   "><a class="portfolio-img-link" href="service-predictive.php"><img class="portfolio-img   img-fluid " loading="lazy" src="assets/images/portfolio/5.jpg" alt="portfolio item photo"/></a>
                <div class="item-info ">
            ...
            <div class="swiper-slide">
              <div class="item   "><a class="portfolio-img-link" href="service-cybersecurity.php"><img class="portfolio-img   img-fluid " loading="lazy" src="assets/images/portfolio/6.jpg" alt="portfolio item photo"/></a>
                <div class="item-info ">
