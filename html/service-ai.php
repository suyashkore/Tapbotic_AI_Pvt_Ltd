...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | Artificial Intelligence</title>
  <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Artificial Intelligence</h1>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/otherimages/2.png" alt="A developer working on an AI project on a laptop" style="max-height: 450px; width: 100%; object-fit: cover;"></div>
          ...
          <div class="col-12 col-xl-4">
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  <li class="list-item active"><i class="flaticon-artificial-intelligence font-icon"></i><a href="service-ai.php"> Artificial Intelligence<i class="bi bi-arrow-right icon "></i></a></li>
