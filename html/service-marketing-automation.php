...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | Marketing Automation</title>
  <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
  ...
  <body class=" dark-theme "> 
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      <div class="overlay-photo-image-bg parallax" data-bg-img="https://images.pexels.com/photos/6476582/pexels-photo-6476582.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" data-bg-opacity="1"></div>
      <div class="overlay-color" data-bg-opacity=".75"></div>
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Marketing Automation</h1>
          <nav aria-label="breadcrumb ">
            <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
              ...
              <li class="breadcrumb-item active">Marketing Automation</li>
            </ul>
          </nav>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/otherimages/6.jpeg" alt="Marketing Automation" style="max-height: 450px; width: 100%; object-fit: cover;"></div>
              <div class="service-content">
                <div class="part">
                  <h2 class="service-title">Streamline Your Marketing with AI</h2>
                  <p class="service-text">At Tapbotic AI, we leverage the power of AI to revolutionize your marketing efforts. Our Marketing Automation solutions are designed to optimize campaigns, personalize customer interactions at scale, and maximize your return on investment through data-driven strategies.</p>
                  <p class="service-text">We move beyond simple email schedulers. Our platforms use machine learning to understand customer behavior, predict needs, and deliver the right message at the right time, through the right channel. From lead nurturing to customer retention, we automate the entire marketing funnel.</p>
                </div>
                <div class="part">
                  <h2 class="service-title">Why Choose Our Marketing Automation?</h2>
                  <p class="service-text">Our approach integrates seamlessly with your existing CRM and sales platforms, creating a unified view of the customer journey. We build intelligent workflows that adapt to customer actions, ensuring a personalized and relevant experience that builds loyalty and drives conversions.</p>
                </div>
                <div class="part">
                      ...
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            <h5 class="info-title">AI-Powered Lead Scoring</h5>
                            <p class="info-text">Automatically score and prioritize leads based on their behavior and demographics to focus sales efforts on the most promising prospects.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">02.</span>
                          <div class="info-content">
                            <h5 class="info-title">Personalized Customer Journeys</h5>
                            <p class="info-text">Create dynamic, multi-channel campaigns that adapt in real-time to user interactions, delivering personalized content and offers.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">03.</span>
                          <div class="info-content">
                            <h5 class="info-title">Predictive Campaign Optimization</h5>
                            <p class="info-text">Use machine learning to forecast campaign performance, optimize ad spend, and identify the most effective marketing channels.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">04.</span>
                          <div class="info-content">
                            <h5 class="info-title">Automated Content & Email Marketing</h5>
                            <p class="info-text">Leverage AI to generate and personalize email content, segment audiences intelligently, and automate drip campaigns for maximum engagement.</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  ...
                  <li class="list-item active"><i class="flaticon-automation font-icon"></i><a href="service-automation.php"> Automation & Robotics<i class="bi bi-arrow-right icon "></i></a></li>
              ...
              <div class="sidebar-pane">
                <div class="download-area">
                  ...
                  <p class="sidebar-text">Get a detailed overview of our Marketing Automation capabilities.</p>
                  <ul class="list">
                    ...
                    <li class="list-item"><i class="flaticon-downloading font-icon"></i><a href="#0">
                         Marketing Automation Deck<i class="bi bi-arrow-right icon "></i></a></li>
                  </ul>
                </div>
              </div>
              <div class="sidebar-pane">
