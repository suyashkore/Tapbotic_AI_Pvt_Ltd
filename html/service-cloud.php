...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | Cloud & DevOps</title>
  <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
  ...
  <body class=" dark-theme "> 
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      <div class="overlay-photo-image-bg parallax" data-bg-img="https://images.pexels.com/photos/373543/pexels-photo-373543.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" data-bg-opacity="1"></div>
      <div class="overlay-color" data-bg-opacity=".75"></div>
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Cloud & DevOps</h1>
          <nav aria-label="breadcrumb ">
            <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
              ...
              <li class="breadcrumb-item active">Cloud & DevOps</li>
            </ul>
          </nav>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/otherimages/4.jpeg" alt="A technician working on servers in a data center, representing cloud infrastructure" style="max-height: 450px; width: 100%; object-fit: cover;"></div>
              <div class="service-content">
                <div class="part">
                  <h2 class="service-title">Cloud Architecture & DevOps Governance</h2>
                  <p class="service-text">Tapbotic AI provides end-to-end cloud and DevOps services to help you build, deploy, and manage applications with greater speed and reliability. We help you leverage the full potential of the cloud to achieve scalability, agility, and cost-efficiency.</p>
                  <p class="service-text">Our certified cloud architects and DevOps engineers work with you to design a robust cloud strategy, automate your infrastructure, and implement a culture of continuous integration and delivery (CI/CD). We ensure your cloud environment is secure, compliant, and optimized for performance.</p>
                </div>
                <div class="part">
                  <h2 class="service-title">Our Cloud & DevOps Expertise</h2>
                  <div class="info-items-list">
                    <div class="row">
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            <h5 class="info-title">Cloud Migration</h5>
                            <p class="info-text">Seamlessly migrate your applications and data to leading cloud platforms like AWS, Azure, and GCP.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">02.</span>
                          <div class="info-content">
                            <h5 class="info-title">DevOps & CI/CD Automation</h5>
                            <p class="info-text">Automating your build, test, and deployment pipelines to accelerate time-to-market.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">03.</span>
                          <div class="info-content">
                            <h5 class="info-title">Infrastructure as Code (IaC)</h5>
                            <p class="info-text">Managing and provisioning infrastructure through code for consistency and repeatability.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">04.</span>
                          <div class="info-content">
                            <h5 class="info-title">Cloud Cost Optimization</h5>
                            <p class="info-text">Analyzing your cloud usage to identify and eliminate wasteful spending, ensuring maximum ROI.</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  ...
                  <li class="list-item active"><i class="flaticon-cloud-computing font-icon"></i><a href="service-cloud.php"> Cloud & DevOps<i class="bi bi-arrow-right icon "></i></a></li>
              ...
              <div class="sidebar-pane">
                <div class="download-area">
                  ...
                  <p class="sidebar-text">Explore our Cloud & DevOps services in detail.</p>
                  <ul class="list">
                    ...
                    <li class="list-item"><i class="flaticon-downloading font-icon"></i><a href="#0">
                         Cloud & DevOps Deck<i class="bi bi-arrow-right icon "></i></a></li>
                  </ul>
                </div>
              </div>
              <div class="sidebar-pane">
