...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | AI-Enhanced Web Apps</title>
  <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
  ...
  <body class=" dark-theme "> 
      ...
      <nav class="menu-navbar">
        ...
        <div class="links menu-wrapper ">
          <ul class="list-js links-list">
            ...
            <li class="menu-item"><a class="menu-link active" href="services.php">Services</a></li>
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      <div class="overlay-photo-image-bg parallax" data-bg-img="https://images.pexels.com/photos/546819/pexels-photo-546819.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" data-bg-opacity="1" ></div>
      <div class="overlay-color" data-bg-opacity=".75"></div>
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">AI-Enhanced Web Apps</h1>
          <nav aria-label="breadcrumb ">
            <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
              <li class="breadcrumb-item"><a class="breadcrumb-link" href="index.php"><i class="bi bi-house icon "></i>home</a></li>
              <li class="breadcrumb-item"><a class="breadcrumb-link" href="services.php">services</a></li>
              <li class="breadcrumb-item active">AI-Enhanced Web Apps</li>
            </ul>
          </nav>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/otherimages/13.jpeg" alt="AI-Enhanced Web Apps" style="max-height: 450px; width: 100%; object-fit: cover;"></div>
              <div class="service-content">
                <div class="part">
                  <h2 class="service-title">Building the Next Generation of Web Applications</h2>
                  <p class="service-text">At Tapbotic AI, we go beyond standard web development. We build intelligent, AI-enhanced web applications that deliver superior user experiences and drive operational efficiency. Our solutions are designed to be responsive, scalable, and deeply integrated with AI capabilities.</p>
                  <p class="service-text">We infuse your web apps with machine learning models, natural language processing, and predictive analytics to create dynamic, personalized, and proactive user interactions. From intelligent e-commerce platforms to data-driven business dashboards, we build web apps that learn and adapt.</p>
                </div>
                <div class="part">
                  <h2 class="service-title">Why Choose Our AI-Enhanced Web Apps?</h2>
                  <p class="service-text">Our development process combines cutting-edge front-end technologies with robust, AI-powered back-end systems. We focus on creating seamless, intuitive interfaces that are backed by powerful data processing and machine learning algorithms.</p>
                  <p class="service-text">Partner with us to build web applications that not only look great but also think smart. We deliver solutions that provide a tangible competitive advantage by automating processes, uncovering insights, and engaging users in new and powerful ways.</p>
                </div>
                <div class="part">
                      ...
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            <h5 class="info-title">Personalized User Experiences</h5>
                            <p class="info-text">Use AI to tailor content, recommendations, and user journeys in real-time based on user behavior.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">02.</span>
                          <div class="info-content">
                            <h5 class="info-title">Intelligent Search & Chatbots</h5>
                            <p class="info-text">Integrate NLP-powered search and conversational AI to help users find information and get support instantly.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">03.</span>
                          <div class="info-content">
                            <h5 class="info-title">Predictive Functionality</h5>
                            <p class="info-text">Embed predictive models to forecast user needs, suggest actions, and automate decision-making within the app.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">04.</span>
                          <div class="info-content">
                            <h5 class="info-title">Automated Data Analysis</h5>
                            <p class="info-text">Build dashboards that don't just display data, but also use AI to highlight trends, anomalies, and key insights automatically.</p>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div class="col-12 col-xl-4">
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  <li class="list-item"><i class="flaticon-artificial-intelligence font-icon"></i><a href="service-ai.php"> Artificial Intelligence<i class="bi bi-arrow-right icon "></i></a></li>
                  <li class="list-item"><i class="flaticon-automation font-icon"></i><a href="service-automation.php"> Automation & Robotics<i class="bi bi-arrow-right icon "></i></a></li>
                  <li class="list-item"><i class="flaticon-web-development font-icon"></i><a href="service-software.php"> Enterprise Software<i class="bi bi-arrow-right icon "></i></a></li>
                  ...
                  <li class="list-item"><i class="flaticon-cyber-security font-icon"></i><a href="service-cybersecurity.php"> Cybersecurity<i class="bi bi-arrow-right icon "></i></a></li>
                </ul>
              </div>
              <div class="sidebar-pane">
                <div class="download-area">
                  <h2 class="sidebar-title">Download Our Brochure</h2>
                  <p class="sidebar-text">Get a detailed overview of our AI & Web App capabilities.</p>
                  <ul class="list">
                    ...
                    <li class="list-item"><i class="flaticon-downloading font-icon"></i><a href="#0">
                         AI Web Apps Deck<i class="bi bi-arrow-right icon "></i></a></li>
                  </ul>
                </div>
              </div>
              <div class="sidebar-pane">
