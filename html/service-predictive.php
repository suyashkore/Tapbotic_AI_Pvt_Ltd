...
<html lang="zxx">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title>Tapbotic AI | Predictive Analytics</title>
  <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
  ...
  <body class=" dark-theme "> 
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      <div class="overlay-photo-image-bg parallax" data-bg-img="https://images.pexels.com/photos/669615/pexels-photo-669615.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" data-bg-opacity="1"></div>
      <div class="overlay-color" data-bg-opacity=".75"></div>
      <div class="container">
        <div class="hero-text-area centerd">
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Predictive Analytics</h1>
          <nav aria-label="breadcrumb ">
            <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
              ...
              <li class="breadcrumb-item active">Predictive Analytics</li>
            </ul>
          </nav>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/otherimages/8.jpeg" alt="Predictive Analytics" style="max-height: 450px; width: 100%; object-fit: cover;"></div>
              <div class="service-content">
                <div class="part">
                  <h2 class="service-title">Transforming Data into Foresight</h2>
                  <p class="service-text">At Tapbotic AI, we specialize in Predictive Analytics, transforming your historical and real-time data into a strategic crystal ball. We use sophisticated statistical models and machine learning algorithms to forecast trends, predict customer behavior, and anticipate business outcomes.</p>
                  <p class="service-text">Our services empower you to make proactive, data-driven decisions. Instead of reacting to what has happened, you can strategically plan for what will happen, optimizing everything from inventory and marketing to operational efficiency and risk management.</p>
                </div>
                <div class="part">
                  <h2 class="service-title">Our Predictive Analytics Solutions</h2>
                  <p class="service-text">Our data scientists work with you to identify key business questions and build custom predictive models that provide answers. We deliver not just algorithms, but clear, actionable insights that integrate seamlessly into your daily operations and strategic planning.</p>
                </div>
                <div class="part">
                      ...
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            <h5 class="info-title">Demand & Sales Forecasting</h5>
                            <p class="info-text">Accurately predict future sales and product demand to optimize your supply chain and inventory levels.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">02.</span>
                          <div class="info-content">
                            <h5 class="info-title">Customer Churn Prediction</h5>
                            <p class="info-text">Identify customers who are likely to leave and develop targeted retention campaigns to keep them.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">03.</span>
                          <div class="info-content">
                            <h5 class="info-title">Predictive Maintenance</h5>
                            <p class="info-text">Forecast potential equipment failures in your manufacturing or operational processes to schedule maintenance proactively.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">04.</span>
                          <div class="info-content">
                            <h5 class="info-title">Financial Risk Modeling</h5>
                            <p class="info-text">Use predictive models to assess credit risk, detect fraud, and forecast financial market trends.</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="service-sidebar ">
              ...
              <div class="sidebar-pane">
                <div class="download-area">
                  ...
                  <p class="sidebar-text">Learn more about our Predictive Analytics services.</p>
                  <ul class="list">
                    ...
                    <li class="list-item"><i class="flaticon-downloading font-icon"></i><a href="#0">
                         Predictive Analytics Deck<i class="bi bi-arrow-right icon "></i></a></li>
                  </ul>
                </div>
              </div>
              <div class="sidebar-pane">
