...
<head>
    ...
    <meta name="description" content="Our Mission - Tapbotic AI Pvt Ltd">
    ...
    <title> Our Mission | Tapbotic AI Pvt Ltd</title>
    <!-- <style>
    .mouse-bubble {
      position: absolute;
      border-radius: 50%;
      background: rgba(84, 163, 247, 0.6);
      pointer-events: none;
      z-index: 9999;
...
<body class=" dark-theme ">
    ...
    <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
        <div class="overlay-photo-image-bg parallax" data-bg-img="https://images.pexels.com/photos/3184418/pexels-photo-3184418.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" data-bg-opacity="1"></div>
        <div class="overlay-color" data-bg-opacity=".75"></div>
        <div class="container">
          <div class="hero-text-area centerd">
            <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Our Mission</h1>
    ...
    <section class="about mega-section" id="mission-details">
        <div class="container">
            ...
            <div class="row">
              <div class="col-12 col-lg-6 d-flex align-items-center order-1 order-lg-0 about-col pad-end wow fadeInUp" data-wow-delay="0.6s">
                <div class="text-area">
                  <div class="sec-heading light-title">
                    <div class="content-area"><span class="pre-title wow fadeInUp" data-wow-delay=".2s">Our Purpose</span>
                      <h2 class="title wow fadeInUp" data-wow-delay=".4s">Empowering Through Technology</h2>
                    </div>
                  </div>
                  <p class="about-text">Our mission is to deliver intelligent and scalable technology solutions that empower businesses. We are dedicated to enabling digital transformation using AI and automation, ensuring that our clients stay ahead in a rapidly evolving digital landscape.</p>
                  <ul class="list-unstyled about-text">
                    <li class="mb-2"> <i class="bi bi-check2-circle icon me-2"></i>Deliver intelligent and scalable technology solutions</li>
                    <li class="mb-2"> <i class="bi bi-check2-circle icon me-2"></i>Enable digital transformation using AI and automation</li>
                    <li class="mb-2"> <i class="bi bi-check2-circle icon me-2"></i>Maintain the highest standards of quality and security</li>
                    <li class="mb-2"> <i class="bi bi-check2-circle icon me-2"></i>Build long-term, trust-based client relationships</li>
                  </ul>
                </div>
              </div>
              <div class="col-12 col-lg-6 d-flex align-items-center order-0 order-lg-1 about-col wow fadeInUp" data-wow-delay="0.2s">
                <div class="img-area" data-tilt>
                  <div class="image"><img class="about-img img-fluid" loading="lazy" src="assets/images/our-purpose/mission_new.png" alt="Our Mission"></div>
                </div>
              </div>
            </div>
          </div>
...
<div class="contact-info-card"><i class="bi bi-phone icon"></i><a class="info" href="tel:+91 7066067737">+91 7066067737</a></div>            <div class="contact-info-card"><i class="bi bi-envelope icon"></i><a class="text-lowercase  info" href="mailto:info@tapboticai.com">info@tapboticai.com</a></div>
  ...
  <script>
    ...
    document.addEventListener('mousemove', function(e) {
      const now = Date.now();
      if (now - lastBubbleTime < 40) return;
      lastBubbleTime = now;
